...
export const ADD_NEW_RESPONSE_STREAM_MESSAGE = 'MESSAGES/ADD_NEW_RESPONSE_STREAM_MESSAGE';
...
export interface AddResponseStreamMessage {
  type: typeof ADD_NEW_RESPONSE_STREAM_MESSAGE;
  text: string;
  id?: string;
}
...
export type MessagesActions = AddUserMessage | AddResponseMessage | AddResponseStreamMessage | AddLinkSnippet | RenderCustomComponent
