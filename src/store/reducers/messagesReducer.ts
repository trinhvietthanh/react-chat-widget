import { MessagesState, MessagesStreamState } from '../types';
...
import {
  ...
  ADD_NEW_RESPONSE_STREAM_MESSAGE,
...
const messagesReducer = {
  ...
  [ADD_NEW_RESPONSE_STREAM_MESSAGE]: (state: MessagesStreamState, { text, id }) => {
      let flag = false;
    ...
    if (flag) {
      ...
      return {
        ...
        messages: [
          ...state.messages,
          createNewStreamMessage(text, MESSAGE_SENDER.RESPONSE, id),
        ],
        badgeCount: state.badgeCount + 1,
      };
    }
