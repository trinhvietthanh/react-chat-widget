...
import MessageStream from '../components/Widget/components/Conversation/components/Messages/components/MessageStream';
...
export function createNewStreamMessage(
  text: string,
  sender: string,
  id ?: string,
): MessageI {
